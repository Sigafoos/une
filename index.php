...
'<h2 id="name">' + generate_name($('#source').val() + '-' + gender) + '</h2>' +
'</div>' +
'<div class="ui-body ui-body-a">' +
'<ul data-role="listview" data-inset="true">' + 
'<li id="descriptor">' + modifier + ' ' + noun + '</li>' + 
'<li id="powerlevel">' + powerlevel + '</li>' + 
'</ul>' +
'<h3>Motivations</h3>' +
'<ul data-role="listview" data-inset="true" id="motivations">' + 
'<li id="motivation1" data-icon="refresh"><a href="#">' + motivation[0][0] + ' ' + motivation[0][1] + '</a></li>' + 
'<li id="motivation2" data-icon="refresh"><a href="#">' + motivation[1][0] + ' ' + motivation[1][1] + '</a></li>' + 
'<li id="motivation3" data-icon="refresh"><a href="#">' + motivation[2][0] + ' ' + motivation[2][1] + '</a></li>' + 
'</ul>' + 
...
//$(response).html('<p>relationship: ' + $('#relationship').val() + ' / mood: ' + $('#mood').val() + '</p>');
		...
		$('#motivations a').on('click',function(){
			var newmotivation;
